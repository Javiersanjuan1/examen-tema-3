...
public:
    ...
    void addSymbol(const std::string& symbol, const Variant& value) {
        // Utiliza emplace para construir directamente el par en el m
...
int main() {
    try {
        ...
        // Agregar algunos símbolos con valores variantes
        myEnvironment.addSymbol("x", Variant(10));
        myEnvironment.addSymbol("y", Variant("Hola, Mundo"));

        // Verificar si un símbolo existe y mostrar su valor
